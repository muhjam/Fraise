            ...
            <ResponsiveContainer>
                <PieChart>
                    <RechartsTooltip
                        ...
                        formatter={(value) => (value as number | undefined)?.toLocaleString("en-US", { style: "currency", currency: "USD", minimumFractionDigits: 0 }) ?? ""}
                    />
                                        ...
                                        <ResponsiveContainer className="h-full">
                                            ...
                                            >
                                                ...
                                                <RechartsTooltip
                                                    ...
                                                    formatter={(value) =>
                                                        (value as number | undefined)?.toLocaleString("en-US", { style: "currency", currency: "USD", minimumFractionDigits: 0 }) ?? ""
                                                    }
